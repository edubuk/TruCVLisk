...
import heroImg from "../assets/Social/hero.png";
  ...
  return (
    <div className="flex justify-center items-center flex-col gap-8 overflow-hidden">
      <div className="relative w-full flex flex-col">
        <div className="relative flex justify-end items-center w-full h-[20px] mt-2 p-6">
          <div className="relative">
            {userImage && (
              <img
                src={userImage}
                className="w-12 h-12 text-[#03257e] rounded-full cursor-pointer"
                onClick={() => setOpenProfile(!openProfile)}
              />
            )}{" "}
            {/* <div className="absolute top-0  w-12 h-12  rounded-full   bg-gradient-to-r from-[#03257e] via-[#006666] to-[#f14419] -z-10"></div> */}
          </div>
          {/* <ProfilePopup openProfile={openProfile}/> */}
        </div>
        <div className="flex justify-around items-center flex-wrap-reverse gap-10 md:gap-20 border-b-4 border-amber-300 md:h-[80vh]">
          <div
            className="flex justify-center items-center flex-col gap-4 pb-4"
            data-aos="fade-up"
          >
            <div className="flex justify-center items-center gap-2">
              <p
                className="text-white bg-[#006666] px-6 py-4 font-bold rounded-lg text-2xl sm:text-3xl md:text-4xl"
                data-aos="fade-right"
              >
                TruCV
              </p>
              <div
                className="flex lg:hidden relative rounded-lg p-[2px] bg-gradient-to-r from-[#03257e] via-[#006666] to-[#f14419]"
                data-aos="fade-left"
              >
                <Link
                  to="/login"
            ...
            <p
              className="text-[#03257E] text-center text-2xl sm:text-3xl md:text-5xl font-bold"
              data-aos="fade-up"
            >
              Your Verifiable CV<br></br> on Blockchain
            </p>
            <p
              className="text-[#f14419] text-center font-bold text-xl sm:text-2xl"
              data-aos="fade-up"
            >
        ...
        <div className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-[#03257e] via-[#006666] to-[#f14419]"></div>
      </div>
